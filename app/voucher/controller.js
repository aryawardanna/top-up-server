...
module.exports = {
  index: async (req, res) => {
    try {
      ...
      res.render('admin-lte/voucher/view_voucher', {
        voucher,
        alert,
  ...
  viewCreate: async (req, res) => {
    try {
      ...
      res.render('admin-lte/voucher/create', {
        category,
        nominal,
        name: req.session.user.name,
  ...
  viewEdit: async (req, res) => {
    try {
      ...
      res.render('admin-lte/voucher/edit', {
        voucher,
        category,
        nominal,
        name: req.session.user.name,
    ...
    try {
      ...
      if (req.file) {
        ...
        src.on('end', async () => {
          try {
            const voucher = await Voucher.findOne({ _id: id });
            let currentImage = `${config.rootPPath}/public/uploads/${voucher.thumbnail}`;
